...
/* ════════════════════════════════════════════════════════════
   4. TUTOR API (Powered by Groq - Llama)
   ─────────────────────────────────────────────────────────
   Ultra-fast, stable hackathon fallback using Groq API.
════════════════════════════════════════════════════════════ */

const TutorAPI = (() => {
  // PASTE YOUR NEW GROQ KEY HERE (Starts with gsk_)
  let apiKey = '';

  function setKey(k) { apiKey = k; }
  function hasKey()  { return apiKey.startsWith('gsk_') && apiKey.length > 20; } 
